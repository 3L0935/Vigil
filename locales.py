...
_STRINGS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "action_negated":      "No action taken.",
        "sources":             "Sources",
        "file_results_spoken": "I found {count} files. Choose a number to open one.",
        "setting_retain_last": "Keep last dictation in memory for five minutes",
        "setting_spoken_formatting": "Spoken new line and paragraph commands",
        "setting_dictation_preview": "Preview dictation before insertion",
        "setting_literal_mode": "Insert those commands as literal words",
        "tray_copy_last": "Copy last dictation",
        "tray_copy_raw": "Copy raw transcript",
        "tray_reinsert_last": "Reinsert last dictation",
        "tray_clear_last": "Clear last dictation",
        "last_dictation_copied": "Last dictation copied.",
        "last_dictation_missing": "No recent dictation is available.",
        "last_dictation_too_large": "Dictation inserted; too large to keep in memory.",
        "last_dictation_reinsert_armed": "Focus the target app, then press the dictation shortcut to insert.",
        "last_dictation_cleared": "Last dictation cleared.",
        "tray_cancel_dictation": "Cancel dictation",
        "dictation_cancelled": "Dictation cancelled.",
        "dictation_cancel_too_late": "Insertion already started; cancellation is too late.",
        "preview_title": "Dictation preview",
        "preview_focus_hint": "Edit here. To insert, choose Insert, focus the target app, then press the dictation shortcut.",
        "preview_copy": "Copy",
        "preview_vocabulary": "Vocabulary",
        "preview_discard": "Discard",
        "preview_insert": "Insert",
        "preview_too_large": "Dictation too large to preview; saved for recovery.",
        "preview_empty": "Preview text is empty.",
        "preview_edit_too_large": "Edited text exceeds the 64 KiB preview limit.",
        "vocabulary_spoken_prompt": "Spoken phrase",
        "vocabulary_written_prompt": "Written replacement",
        "vocabulary_confirm": "Save this replacement?\n{spoken} → {written}",
        "setting_llm_profile": "Generation profile (model profile is experimental)",
        "choice_llm_compat": "Compatible default",
        "choice_llm_model": "Model recommendation",
    ...
    "it": {
        ...
        "action_negated":      "Nessuna azione eseguita.",
        "sources":             "Fonti",
        "file_results_spoken": "Ho trovato {count} file. Scegli un numero per aprirne uno.",
        "setting_retain_last": "Conserva l’ultima dettatura in memoria per cinque minuti",
        "setting_spoken_formatting": "Comandi vocali per riga e paragrafo",
        "setting_dictation_preview": "Mostra anteprima prima dell’inserimento",
        "setting_literal_mode": "Inserisci quei comandi come parole letterali",
        "tray_copy_last": "Copia l’ultima dettatura",
        "tray_copy_raw": "Copia la trascrizione originale",
        "tray_reinsert_last": "Reinserisci l’ultima dettatura",
        "tray_clear_last": "Cancella l’ultima dettatura",
        "last_dictation_copied": "Ultima dettatura copiata.",
        "last_dictation_missing": "Nessuna dettatura recente disponibile.",
        "last_dictation_too_large": "Dettatura inserita; troppo grande per restare in memoria.",
        "last_dictation_reinsert_armed": "Attiva l’app di destinazione, poi premi la scorciatoia di dettatura.",
        "last_dictation_cleared": "Ultima dettatura cancellata.",
        "tray_cancel_dictation": "Annulla dettatura",
        "dictation_cancelled": "Dettatura annullata.",
        "dictation_cancel_too_late": "Inserimento già avviato; troppo tardi per annullare.",
        "preview_title": "Anteprima dettatura",
        "preview_focus_hint": "Modifica qui. Per inserire, scegli Inserisci, attiva l’app di destinazione e premi la scorciatoia di dettatura.",
        "preview_copy": "Copia",
        "preview_vocabulary": "Vocabolario",
        "preview_discard": "Scarta",
        "preview_insert": "Inserisci",
        "preview_too_large": "Dettatura troppo grande per l’anteprima; salvata per il recupero.",
        "preview_empty": "L’anteprima è vuota.",
        "preview_edit_too_large": "Il testo modificato supera il limite di anteprima di 64 KiB.",
        "vocabulary_spoken_prompt": "Frase pronunciata",
        "vocabulary_written_prompt": "Sostituzione scritta",
        "vocabulary_confirm": "Salvare questa sostituzione?\n{spoken} → {written}",
        "setting_llm_profile": "Profilo di generazione (profilo modello sperimentale)",
        "choice_llm_compat": "Predefinito compatibile",
        "choice_llm_model": "Raccomandazione del modello",
    ...
    "fr": {
        ...
        "action_negated":      "Aucune action effectuée.",
        "sources":             "Sources",
        "file_results_spoken": "J'ai trouvé {count} fichiers. Choisissez un numéro pour en ouvrir un.",
        "setting_retain_last": "Garder la dernière dictée en mémoire pendant cinq minutes",
        "setting_spoken_formatting": "Commandes vocales de ligne et de paragraphe",
        "setting_dictation_preview": "Afficher un aperçu avant l’insertion",
        "setting_literal_mode": "Insérer ces commandes comme mots littéraux",
        "tray_copy_last": "Copier la dernière dictée",
        "tray_copy_raw": "Copier la transcription brute",
        "tray_reinsert_last": "Réinsérer la dernière dictée",
        "tray_clear_last": "Effacer la dernière dictée",
        "last_dictation_copied": "Dernière dictée copiée.",
        "last_dictation_missing": "Aucune dictée récente disponible.",
        "last_dictation_too_large": "Dictée insérée ; trop longue pour être gardée en mémoire.",
        "last_dictation_reinsert_armed": "Activez l’application cible, puis appuyez sur le raccourci de dictée.",
        "last_dictation_cleared": "Dernière dictée effacée.",
        "tray_cancel_dictation": "Annuler la dictée",
        "dictation_cancelled": "Dictée annulée.",
        "dictation_cancel_too_late": "L’insertion a déjà commencé ; annulation trop tardive.",
        "preview_title": "Aperçu de la dictée",
        "preview_focus_hint": "Modifiez ici. Pour insérer, choisissez Insérer, activez l’application cible puis appuyez sur le raccourci de dictée.",
        "preview_copy": "Copier",
        "preview_vocabulary": "Vocabulaire",
        "preview_discard": "Ignorer",
        "preview_insert": "Insérer",
        "preview_too_large": "Dictée trop longue pour l’aperçu ; sauvegardée pour récupération.",
        "preview_empty": "L’aperçu est vide.",
        "preview_edit_too_large": "Le texte modifié dépasse la limite de 64 Kio de l’aperçu.",
        "vocabulary_spoken_prompt": "Expression prononcée",
        "vocabulary_written_prompt": "Remplacement écrit",
        "vocabulary_confirm": "Enregistrer ce remplacement ?\n{spoken} → {written}",
        "setting_llm_profile": "Profil de génération (profil modèle expérimental)",
        "choice_llm_compat": "Valeur compatible",
        "choice_llm_model": "Recommandation du modèle",
