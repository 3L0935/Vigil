...
_STRINGS: dict[str, dict[str, str]] = {
    "en": {
        ...
        'answer_copy': 'Copy',
        'answer_close': 'Close answer',
        'answer_copied': 'Copied',
        'answer_typing': 'Writing…',
        'answer_waiting': 'Waiting for reply',
        'answer_speaking': 'Speaking…',
        'answer_paused': 'Paused',
        ...
        'setup_progress_speech': 'Downloading the dictation model…',
        ...
        'setup_binary_not_found': 'No compatible llama-server package is available for this backend. Choose an existing binary or another backend.',
        'setup_binary_cannot_start': 'The downloaded llama-server cannot start here. Choose another backend or an existing binary.',
        ...
        'vocabulary_hint': 'Write one replacement per line: what Whisper transcribes = desired spelling. Dictation only.',
        'vocabulary_example': 'vigil local = Vigil Local',
        ...
        'priming_hint': 'List names and technical terms, separated by commas. This guides recognition but does not force spelling.',
        'priming_example': 'Vigil, ROCm, Obsidian',
        ...
        "one_action":          "Please request one action at a time.",
        "sources":             "Sources",
        "file_results_spoken": "I found {count} files. Choose a number to open one.",
        ...
        "group_theme":              "Theme",
        "theme_presets":           "Starting palettes",
        "theme_preset_vigil":      "Vigil",
        "theme_preset_classic_dark": "Classic dark",
        "theme_preset_classic_light": "Classic light",
        "theme_preset_high_contrast": "High contrast",
        "theme_background":        "Window background",
        "theme_surface":           "Panel surface",
        "theme_raised":            "Raised surface",
        "theme_control":           "Input background",
        "theme_text":              "Main text",
        "theme_muted":             "Secondary text",
        "theme_line":              "Borders and dividers",
        "theme_accent_a":           "Accent color",
        "theme_accent_b":           "Second color",
        "theme_glass_opacity":     "Overlay opacity",
        "theme_window_opacity":    "Window opacity",
        "theme_gradient":           "Two-color gradient",
        "theme_reduced_motion":     "Reduce motion",
    ...
    "it": {
        ...
        'answer_copy': 'Copia',
        'answer_close': 'Chiudi risposta',
        'answer_copied': 'Copiato',
        'answer_typing': 'Scrittura…',
        'answer_waiting': 'In attesa della risposta',
        'answer_speaking': 'Riproduzione…',
        'answer_paused': 'In pausa',
        ...
        'setup_progress_speech': 'Download del modello di dettatura…',
        ...
        'setup_binary_not_found': 'Nessun pacchetto llama-server compatibile per questo backend. Scegli un binario esistente o un altro backend.',
        'setup_binary_cannot_start': 'Il llama-server scaricato non si avvia qui. Scegli un altro backend o un binario esistente.',
        ...
        'vocabulary_hint': 'Una sostituzione per riga: testo trascritto da Whisper = forma desiderata. Solo dettatura.',
        'vocabulary_example': 'vigil locale = Vigil Local',
        ...
        'priming_hint': 'Elenca nomi e termini tecnici separati da virgole. Guidano il riconoscimento senza imporre la grafia.',
        'priming_example': 'Vigil, ROCm, Obsidian',
        ...
        "one_action":          "Chiedi un'azione alla volta.",
        "sources":             "Fonti",
        "file_results_spoken": "Ho trovato {count} file. Scegli un numero per aprirne uno.",
        ...
        "group_overlay":            "Overlay",
        "group_theme":              "Tema",
        "theme_presets":           "Tavolozze di partenza",
        "theme_preset_vigil":      "Vigil",
        "theme_preset_classic_dark": "Scuro classico",
        "theme_preset_classic_light": "Chiaro classico",
        "theme_preset_high_contrast": "Alto contrasto",
        "theme_background":        "Sfondo della finestra",
        "theme_surface":           "Superficie dei pannelli",
        "theme_raised":            "Superficie in rilievo",
        "theme_control":           "Sfondo dei controlli",
        "theme_text":              "Testo principale",
        "theme_muted":             "Testo secondario",
        "theme_line":              "Bordi e divisori",
        "theme_accent_a":           "Colore principale",
        "theme_accent_b":           "Secondo colore",
        "theme_glass_opacity":     "Opacità dell'overlay",
        "theme_window_opacity":    "Opacità delle finestre",
        "theme_gradient":           "Gradiente a due colori",
        "theme_reduced_motion":     "Riduci animazioni",
        "theme_reset":              "Ripristina tema",
    ...
    "fr": {
        ...
        'answer_copy': 'Copier',
        'answer_close': 'Fermer la réponse',
        'answer_copied': 'Copié',
        'answer_typing': 'Écriture…',
        'answer_waiting': 'En attente de réponse',
        'answer_speaking': 'Lecture…',
        'answer_paused': 'En pause',
        ...
        'setup_progress_speech': 'Téléchargement du modèle de dictée…',
        ...
        'setup_binary_not_found': 'Aucun paquet llama-server compatible pour ce moteur. Choisissez un binaire existant ou un autre moteur.',
        'setup_binary_cannot_start': 'Le llama-server téléchargé ne démarre pas ici. Choisissez un autre moteur ou un binaire existant.',
        ...
        'vocabulary_hint': 'Une correction par ligne : ce que Whisper transcrit = écriture souhaitée. Pour la dictée uniquement.',
        'vocabulary_example': 'roque aime = ROCm',
        ...
        'priming_hint': 'Listez les noms et termes techniques, séparés par des virgules. Cela guide la reconnaissance sans garantir l’orthographe.',
        'priming_example': 'Vigil, ROCm, Obsidian',
        ...
        "one_action":          "Demandez une action à la fois.",
        "sources":             "Sources",
        "file_results_spoken": "J'ai trouvé {count} fichiers. Choisissez un numéro pour en ouvrir un.",
        ...
        "group_theme":              "Thème",
        "theme_presets":           "Palettes de départ",
        "theme_preset_vigil":      "Vigil",
        "theme_preset_classic_dark": "Sombre classique",
        "theme_preset_classic_light": "Clair classique",
        "theme_preset_high_contrast": "Contraste élevé",
        "theme_background":        "Fond des fenêtres",
        "theme_surface":           "Fond des panneaux",
        "theme_raised":            "Surface surélevée",
        "theme_control":           "Fond des champs",
        "theme_text":              "Texte principal",
        "theme_muted":             "Texte secondaire",
        "theme_line":              "Bordures et séparateurs",
        "theme_accent_a":           "Couleur d’accent",
        "theme_accent_b":           "Seconde couleur",
        "theme_glass_opacity":     "Opacité de l’overlay",
        "theme_window_opacity":    "Opacité des fenêtres",
        "theme_gradient":           "Dégradé à deux couleurs",
        "theme_reduced_motion":     "Réduire les animations",
